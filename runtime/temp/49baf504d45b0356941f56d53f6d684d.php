<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"/home/www/WWW/public/../application/admin/view/index/mv.html";i:1518237610;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
      <meta charset="utf-8" />
...
<div id="wrapper">
    ...
    <div id="page-wrapper" >
        <div id="search-div">
            ...
            <div>
                <form action="<?php echo url('index/mv'); ?>" method="get">
                    <input type="text" name="search" autofocus=true value=<?php echo $search; ?>>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $vo['outer_address']; ?></td>
...
<div class="modal fade" id="myModal0" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width:80%">
        <form action="<?php echo url('mv/add'); ?>" method="post">
        <div class="modal-content" style="width:100%">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">新增mv信息</h4>
            </div>
            <div class="modal-body" style="width:100%">
                    <table border="1px" style="text-align:center;width:100%;"  id="table">
                        <tr>
                            <td>music_id</td><td><input type="text" name="music_id" ></td>
                        </tr>
                        <tr>
                            <td>内部地址</td><td><input type="text" name="inner_address" ></td>
                        </tr>
                        <tr>
                            <td>外部地址</td><td><input type="text" name="outer_address" ></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>mv类型</td><td><input type="text" name="type"></td>
                        </tr>
                    </table>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width:80%">
        <form action="<?php echo url('mv/del'); ?>" method="post">
        <div class="modal-content" style="width:100%">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">删除mv信息</h4>
            </div>
...
<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width:80%">
        <form action="<?php echo url('mv/edit'); ?>" method="post">
        <div class="modal-content" style="width:100%">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">修改mv信息</h4>
            </div>
            <div class="modal-body" style="width:100%">
                    <table border="1px" style="text-align:center;width:100%;"  id="table">
                        <tr>
                        ...
                        <tr>
                            <td>music_id</td><td><input type="text" name="music_id" id="music_id"></td>
                        </tr>
                        <tr>
                            <td>内部地址</td><td><input type="text" name="inner_address" id="inner_address"></td>
                        </tr>
                        <tr>
                            <td>外部地址</td><td><input type="text" name="outer_address" id="outer_address"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>mv类型</td><td><input type="text" name="type" id="type"></td>
                        </tr>
                    </table>
    ...
    $(function(){
       $(".edit_button").click(function(){
            ...
            $.ajax({
                type:"POST",
                dataType:"JSON",
                url:"<?php echo url('mv/editAjaxReturn'); ?>",
                data:{id:id},
                success:function(data){
                    ...
                    $("#inner_address").val(data.inner_address);
                    $("#outer_address").val(data.outer_address);
                }
            });
        });
