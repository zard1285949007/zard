<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\phpstudy\WWW\public/../application/admin\view\index\system_message.html";i:1513431333;}*/ ?>
﻿<!DOCTYPE html>
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="javascript:;" class="fa-2x active-menu"><i class="glyphicon glyphicon-tree-conifer fa-2x"></i>系统设置<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="<?php echo url('system_email'); ?>" class="fa-2x">发邮件</a>
                        </li>
                        <li>
                            <a class="fa-2x" href="<?php echo url('system_message'); ?>">留言</a>
                        </li>
                    </ul>
                  </li>  
              <li>
