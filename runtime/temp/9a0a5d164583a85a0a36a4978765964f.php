<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"D:\phpstudy\WWW\public/../application/admin\view\index\ui.html";i:1513429917;}*/ ?>
﻿<!DOCTYPE html>
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                 ...
                 <li>
                    <a  class="fa-2x active-menu" href="<?php echo url('ui'); ?>"><i class="glyphicon glyphicon-film fa-2x"></i>M V</a>
                </li>
                <li>
                    <a  class="fa-2x" href="tab-panel.html"><i class="glyphicon glyphicon-music fa-2x"></i>muisc</a>
                </li>
                <li>
                    <a   class="fa-2x" href="chart.html"><i class="glyphicon glyphicon-picture fa-2x"></i>picture</a>
                </li>                          
                <li>
                    <a href="#" class="fa-2x"><i class="glyphicon glyphicon-tree-conifer fa-2x"></i>系统设置<span class="fa arrow"></span></a>
              ...
              <li>
                    <a class="fa-2x" href="blank.html"><i class="fa fa-square-o fa-2x"></i>空白页</a>
                </li>
            </ul>   
        </div>       
    </nav> 
