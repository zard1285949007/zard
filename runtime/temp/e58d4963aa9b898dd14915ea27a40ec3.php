<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/home/www/WWW/public/../application/index/view/music/index.html";i:1518278858;s:63:"/home/www/WWW/public/../application/index/view/common_head.html";i:1518756352;s:63:"/home/www/WWW/public/../application/index/view/common_foot.html";i:1517801129;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
...
<div class="container" style="margin:0px;width:100%">
    ...
    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <div class="col-md-3 col-sm-4 col-xs-12  div-common" style="margin-top:25px" onclick="detail(<?php echo $vo['id']; ?>)">
            <a href="javascript:" target="_blank">
                <div class="music-module">
                    <div class="music-body" style="position:relative">
                        <a href="javascript:" data-toggle="popover" data-html="true" data-placement="top" data-content="<div><p>发行时间：<?php echo date('Y-m-d',$vo['issue_time']); ?></p><p>中文名/日文名：<?php echo $vo['chinese_name']; ?></p><p>作曲：<?php echo $vo['composer']; ?></p><p>作词：<?php echo $vo['lyricists']; ?></p><p>tips：<?php echo $vo['comment']; ?></p></div>" data-container="body" data-trigger="hover">
                        <span class="badge" style="position:absolute;top:0px;left:0px;z-index:5">?                            
                        </span>
                        </a>
                        <div class="music-body-left" style="padding-top:15px">
                            <p style="color:black;font-weight:bold"><?php echo $vo['japanese_name']; ?></p>
                        </div>
                        <div class="music-body-rightall">
                            <div class="music-body-hover glyphicon glyphicon-play-circle" src=<?php echo $vo['src']; ?>></div>
                        </div>
                    </div>
...
<script>
        // 跳转到详细的音乐页面
        function detail(id){
            var url="/index/music/detail.html?id="+id;
            window.open(url);
        }
        $(function (){
             //将文本的焦点移到最后
