 ...
 */
namespace api\qqlogin;
require_once(QQ_CONNECT_SDK_CLASS_PATH."Recorder.php");
require_once(QQ_CONNECT_SDK_CLASS_PATH."URL.php");
require_once(QQ_CONNECT_SDK_CLASS_PATH."ErrorCase.php");
