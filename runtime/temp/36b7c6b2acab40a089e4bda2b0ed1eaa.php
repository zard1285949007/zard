<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\phpstudy\WWW\public/../application/admin\view\index\music.html";i:1513946210;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
      <meta charset="utf-8" />
...
<div class="modal fade" id="myModal0" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width:800px">
        <form action="<?php echo url('index/music'); ?>" method="post">
    ...
    <script src="__STATIC__/admin/index/music.js"></script>
      <!-- BOOTSTRAP SCRIPTS -->
